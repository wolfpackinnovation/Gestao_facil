...
export function PremiumModal({ type, onClose }: PremiumModalProps) {
  ...
  const title = type === 'client' ? 'Limite de Clientes' : 'Limite de Produtos';
  const message = type === 'client'
    ? 'Você atingiu o limite de 3 clientes.\nTorne-se premium para cadastrar clientes ilimitados.'
    : 'Você atingiu o limite de 3 produtos.\nTorne-se premium para cadastrar produtos ilimitados.';
